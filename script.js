...
window.addEventListener('DOMContentLoaded', () => {
        ...
        if (contactForm && formStatus) {
            contactForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    const response = await fetch('https://mor8creator-backend.onrender.com/api/messages', {
                        method: 'POST',
                        headers: {
    ...
    const setupBlogAPI = async () => {
        ...
        const API_URL = 'https://mor8creator-backend.onrender.com/api';
    ...
    const setupAdminLogin = () => {
        ...
        if (loginForm && loginStatus) {
            loginForm.addEventListener('submit', async (e) => {
                ...
                try {
                    const response = await fetch('https://mor8creator-backend.onrender.com/api/auth/login', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
    ...
    const setupAdminDashboard = () => {
        ...
        if (postForm) {
            postForm.addEventListener('submit', (e) => {
                ...
                handleInyection('https://mor8creator-backend.onrender.com/api/posts', data, document.getElementById('post-status'), postForm);
            });
        }
        ...
        if (tutorialForm) {
            tutorialForm.addEventListener('submit', (e) => {
                ...
                handleInyection('https://mor8creator-backend.onrender.com/api/tutorials', data, document.getElementById('tutorial-status'), tutorialForm);
            });
        }
        ...
        if (courseForm) {
            courseForm.addEventListener('submit', (e) => {
                ...
                handleInyection('https://mor8creator-backend.onrender.com/api/courses', data, document.getElementById('course-status'), courseForm);
            });
        }
    };
